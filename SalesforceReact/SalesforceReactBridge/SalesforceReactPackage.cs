...
namespace Salesforce.SDK.ReactNative
{
    ...
    /// managers from).
    /// </summary>
    public class SalesforceReactPackage : IReactPackage
    {
        /// <summary>
        ...
        public IReadOnlyList<INativeModule> CreateNativeModules(ReactContext reactContext)
        {
            ...
            {
                new SalesforceNetReactBridge(),
                new SalesforceOauthReactBridge(),
                new SmartStoreReactBridge(),
                new SmartSyncReactBridge(),
            };
        }
